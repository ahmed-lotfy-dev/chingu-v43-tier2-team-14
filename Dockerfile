...
ARG GOOGLE_BOOKAPI={GOOGLE_BOOKAPI}
ARG GOOGLE_BOOKAPI_URL={GOOGLE_BOOKAPI_URL}
ARG GOOGLE_ID={GOOGLE_ID}
ARG GOOGLE_SECRET={GOOGLE_SECRET}
ARG MONGO_URI={MONGO_URI}
ARG NYTIMES_BOOK_KEY={NYTIMES_BOOK_KEY}
ARG NYTIMES_BOOK_SECRET={NYTIMES_BOOK_SECRET}
ARG NYTIMES_BOOK_URL={NYTIMES_BOOK_URL}
ARG PORT={PORT}
