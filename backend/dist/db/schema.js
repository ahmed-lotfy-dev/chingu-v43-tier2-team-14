import { uuid, pgTable, text, timestamp, boolean, primaryKey, } from "drizzle-orm/pg-core";
...
const orderCart = pgTable("order_cart", {
...
export { user, session, account, verification, book, userBook, cart, order, orderCart, };
